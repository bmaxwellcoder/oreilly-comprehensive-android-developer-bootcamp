...
//        new QuestionBank().getQuestions();
    ...
    private void shareScore() {
        ...
        String subject = "I am Playing Trivia!";
        String message ="My current Score: "
                + score.getScore() + " My highest Score: " + prefs.getHighScore();
    ...
    private void updateQuestion() { // helps update the UI
        ...
        if (score.getScore() > prefs.getHighScore()) {
            ...
            prefs.saveHighScore(prefs.getHighScore());
        }
        highestScoreTextView.setText(MessageFormat.format("Highest Score: {0}", String.valueOf(prefs.getHighScore())));
    }
